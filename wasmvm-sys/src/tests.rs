...
use crate::test_utils::CYBERPUNK_WASM;
...
// Include the precompiled cyberpunk WASM contract used for testing. The file is
// renamed with a `.txt` extension to satisfy repository merge requirements.
static CYBERPUNK: Lazy<&[u8]> = Lazy::new(|| CYBERPUNK_WASM.as_slice());
